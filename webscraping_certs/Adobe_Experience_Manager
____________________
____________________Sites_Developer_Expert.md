...
After exam
Renew certification
This is the most updated exam for the Adobe Experience Manager Sites Developer Expert certification. Please refer the study materials on this page and be sure to schedule the AD0-E137 exam.


For Japanese exam, please schedule AD0-E134-J exam.
EXAM ID:
AD0-E137
LEVEL:
...
Section 1: Configurations (24%)
Given a scenario, identify which dispatcher rule to implement
Given a scenario, determine the steps to configure multi-tenancy
Given a scenario, determine the steps to configure OOTB SAML and LDAP integration
Determine the steps to set up replication agents
Given a scenario, identify the steps to configure editable templates or content fragment models
Section 2: AEM development (33%)
Given a scenario, determine the steps to implement SPA structure, Sling Model Exporter, templates, and components
Given a requirement, identify the steps to create custom components including the HTL, models, and services
Given a scenario, determine the method to create unit tests and map mock data
Given a scenario, determine the approach to develop a third-party API integration
Given a scenario, determine the approach to implement OSGi services or servlet types
Given a scenario, select the appropriate JCR query
Section 3: Build and Deployment (25%)
Identify the steps to set-up and maintain front-end and back-end dependency management
Given a scenario, identify the command to create a project using Maven archetype
Given a scenario, identify the steps to create a custom run mode configuration
Given a scenario, determine the steps to configure workflows
Given a scenario, determine the method to create and manage custom Oak indexes
Section 4: Environment Maintenance (18%)
Given a scenario, determine the steps required to manage AEM environments configuration
Identify the process regarding AEM release management
Identify the steps use package manager to sync content/configurations across AEM environments
Given a scenario, identify which maintenance tool to use
...
<html dir="ltr" lang="en-US"><head>
    ...
    <base href="/certification/sites-developer-expert-v2">
    ...
    <title>
                Adobe Digital Experience Certification Program | Sites Developer Expert
            </title>
    <!-- Stylesheets -->
    <!-- Core -->
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                                ...
                                <a href="/certifications">Certification Catalog</a>
                                                    ...
                                                    <li class="breadcrumb-item" aria-current="page">
                                <a href="/certification/sites-developer-expert-v2">Adobe Experience Manager Sites Developer Expert</a>
                            </li>
                                            </ol>
                </nav>
            </div>
        ...
        <div class="container">
			...
			<div class="d-flex">
				...
				<div class="flex-grow-1 ps-3">
					<p class="text-white m-0">This is the most updated exam for the Adobe Experience Manager Sites Developer Expert certification. Please refer the study materials on this page and be sure to <a href="/courses/1222" style="color:#fff; text-decoration:underline !important">schedule the AD0-E137 exam.</a>
<br>
<br>
For Japanese exam, please schedule <a href="https://certification.adobe.com/courses/166" style="color:#fff; text-decoration:underline !important">AD0-E134-J exam.</a></p>
				</div>
			</div>
		</div>
		...
		<div class="col-12">
			...
			<div class="row mx-0 px-2 px-md-4">
				...
				<div class="col-md-7">
					<p class="mb-0 text-dark">AD0-E137</p>
				</div>
			</div>
			<hr>
			<div class="row mx-0 px-2 px-md-4">
			...
			<div class="accordion-item">
				...
				<div id="exam-details-accordion-item-1" class="accordion-collapse collapse show">
					<div class="accordion-body">
						...
						<br>
						<ul>
  <li>Senior Adobe Experience Manager Developer</li>
  <li>Adobe Experience Manager Developer</li>
</ul>
					</div>
				</div>
			</div>
  ...
  The Minimally Qualified Candidate (MQC) is an application developer with a minimum of 12 months experience working with the AEM Platform. The candidate should be able to perform advanced component development, have a deep understanding of the Model View Controller (MVC) framework, be aware of frameworks and libraries in AEM. In addition, the MQC will have an understanding of the AEM development life cycle.
			...
			<div class="accordion-item">
				...
				<div id="exam-details-accordion-item-3" class="accordion-collapse collapse">
					<div class="accordion-body">
						<p>
  <strong>Section 1: Configurations (24%)</strong>
</p>

<ul>
  <li>Given a scenario, identify which dispatcher rule to implement</li>
  <li>Given a scenario, determine the steps to configure multi-tenancy</li>
  <li>Given a scenario, determine the steps to configure OOTB SAML and LDAP integration</li>
  <li>Determine the steps to set up replication agents</li>
  <li>Given a scenario, identify the steps to configure editable templates or content fragment models</li>
</ul>

<br>
<p>
  <strong>Section 2: AEM development (33%)</strong>
</p>

<ul>
  <li>Given a scenario, determine the steps to implement SPA structure, Sling Model Exporter, templates, and components</li>
  <li>Given a requirement, identify the steps to create custom components including the HTL, models, and services</li>
  <li>Given a scenario, determine the method to create unit tests and map mock data</li>
  <li>Given a scenario, determine the approach to develop a third-party API integration</li>
  <li>Given a scenario, determine the approach to implement OSGi services or servlet types</li>
  <li>Given a scenario, select the appropriate JCR query</li>
</ul>

<br>
<p>
  <strong>Section 3: Build and Deployment (25%)</strong>
</p>

<ul>
  <li>Identify the steps to set-up and maintain front-end and back-end dependency management</li>
  <li>Given a scenario, identify the command to create a project using Maven archetype</li>
  <li>Given a scenario, identify the steps to create a custom run mode configuration</li>
  <li>Given a scenario, determine the steps to configure workflows</li>
  <li>Given a scenario, determine the method to create and manage custom Oak indexes</li> 
</ul>

<br>
<p>
  <strong>Section 4: Environment Maintenance (18%)</strong>
</p>

<ul>
  <li>Given a scenario, determine the steps required to manage AEM environments configuration</li>
  <li>Identify the process regarding AEM release management</li>
  <li>Identify the steps use package manager to sync content/configurations across AEM environments</li>
  <li>Given a scenario, identify which maintenance tool to use</li>
</ul>
					</div>
				</div>
			</div>
	...
	<div class="accordion" id="study-exam-accordion-control">
				...
				<div id="study-exam-accordion-item-2" class="accordion-collapse collapse">
					<div class="accordion-body">
						<p></p>
						<a href="https://certification.adobe.com/courses/1225" target="_blank" class="theme-btn btn-primary-blue">View Practice Test</a>
					</div>
				</div>
			</div>
								<div class="accordion-item">
			...
			<div id="study-exam-accordion-item-4" class="accordion-collapse collapse">
				<div class="accordion-body">
					...
					<a href="https://certification.adobe.com/courses/1224" target="_blank" class="theme-btn btn-primary-blue">View Exam Prep Guide</a>
				</div>
			</div>
		</div>
			</div>
		...
		<div class="accordion-item">
			...
			<div id="schedule-accordion-item-1" class="accordion-collapse collapse">
				<div class="accordion-body">
					<b>Exam delivery</b>
<br>
Adobe works with a vendor called Meazure Learning to administer scheduled, proctored certification exams. Because certification exams are proctored, it is important to read the <a href="https://certification.adobe.com/certifications/learn-more?tab=learnmore6">testing instructions</a> before your exam appointment. 
<br>
<br>
<b>Payment</b><br> 
...
<b>Resources</b>
<br>
Detailed information on <a href="https://certification.adobe.com/certifications/learn-more?tab=learnmore5">pricing, payment, and discounts</a>.
<br>
...
<br>
<a href="https://certification.adobe.com/courses/1222">AD0-E137 Adobe Experience Manager Sites Developer Expert</a>
<br>
<a href="https://certification.adobe.com/courses/166">AD0-E134-J Adobe Experience Manager Sites Developer Expert Japanese Exam</a>
<br>
<br>
<b>Important:</b><br>
<ul>
...
<b>Take your exam</b>
</p><p>Click the link below to access the exam page. Then, click on <b>Take exam</b>.
</p>
<a href="https://certification.adobe.com/courses/1222">AD0-E137 Adobe Experience Manager Sites Developer Expert</a>
