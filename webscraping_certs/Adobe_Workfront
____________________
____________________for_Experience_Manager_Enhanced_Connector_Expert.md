# Adobe Workfront
                    ...
                    for Experience Manager Enhanced Connector Expert
...
AD0-E906 Adobe Workfront for Experience Manager enhanced connector Expert
Take your exam
...
<html dir="ltr" lang="en-US"><head>
    ...
    <base href="/certification/experience-manager-enhanced-connector-expert">
    ...
    <title>
                Adobe Digital Experience Certification Program | for Experience Manager Enhanced Connector Expert
            </title>
    <!-- Stylesheets -->
    <!-- Core -->
...
<body class="stretched pace-running device-lg"><div class="pace pace-active"><div class="pace-progress" data-progress-text="22%" data-progress="22" style="transform: translate3d(22.5225%, 0px, 0px);">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                                ...
                                <a href="/certifications">Certification Catalog</a>
                                                    ...
                                                    <li class="breadcrumb-item" aria-current="page">
                                <a href="/certification/experience-manager-enhanced-connector-expert">Adobe Workfront for Experience Manager Enhanced Connector Expert</a>
                            </li>
                                            </ol>
                </nav>
            </div>
        ...
        <div class="title_section main-header" style="background-image: url(//images.ctfassets.net/pbnabi38gdk3/6QQTlXNRTcj9p5tzQ1U5hP/3a407eeffd9beeddb1f72f8b0f49e8d7/Cert_Exam_Header_KMK_RED_Expert.png); background-size: contain;">
            <div class="container">
                ...
                <h1 class="text-white">Adobe Workfront
                    <br>
                    for Experience Manager Enhanced Connector Expert</h1>
	...
	<li class="nav-item" role="presentation"><button class="nav-link" id="certificate7" data-bs-toggle="tab" data-bs-target="#CertificateCont7" type="button" role="tab" aria-controls="CertificateCont7" aria-selected="false" data-tab="renew-certification" tabindex="-1">Renew certification</button></li>
		...
		<div class="col-12">
			...
			<div class="row mx-0 px-2 px-md-4">
				...
				<div class="col-md-7">
					<p class="mb-0 text-dark">AD0-E906</p>
				</div>
			</div>
			<hr>
			<div class="row mx-0 px-2 px-md-4">
			...
			<div class="row mx-0 px-2 px-md-4">
				...
				<div class="col-md-7">
					<p class="mb-0 text-dark">34/55</p>
				</div>
			</div>
			<hr>
			<div class="row mx-0 px-2 px-md-4">
			...
			<div class="accordion-item">
				...
				<div id="exam-details-accordion-item-1" class="accordion-collapse collapse show">
					<div class="accordion-body">
						...
						<br>
						<ul>
<li> Partner solutions consultants</li>
<li>Implementation specialists</li>
<li>Integration specialists</li>
<li>Developers or architects</li>
</ul>
					</div>
				</div>
			</div>
...
<li>An understanding of work management best practices</li>
			...
			<div class="accordion-item">
				...
				<div id="exam-details-accordion-item-3" class="accordion-collapse collapse">
					<div class="accordion-body">
						<p> <strong>Section 1: Technical requirements (25%) </strong></p><strong> </strong>
...
<p><strong> Section 2: Configuration (26%)</strong></p><strong> </strong>
...
<p><strong> Section 3: Business practices (21%)</strong></p><strong> </strong>
...
<p><strong> Section 4: Installation and configuration of connector (28%)</strong></p><strong> </strong>
...
<li>Given a customer use case, identify the features of the connector to implement</li>
	...
	<div class="accordion" id="study-exam-accordion-control">
			...
			<div id="study-exam-accordion-item-1" class="accordion-collapse collapse">
				<div class="accordion-body">
					<a href="https://scorpion.caveon.com/launchpad/ad3-e906-adobe-workfront-for-experience-manager-enhanced-connector-certified-expert-sample-questions#_blank"> View sample questions </a>
				</div>
			</div>
		</div>
										<div class="accordion-item">
			...
			<div id="study-exam-accordion-item-4" class="accordion-collapse collapse">
				<div class="accordion-body">
					...
					<a href="https://certification.adobe.com/courses/1208" target="_blank" class="theme-btn btn-primary-blue">View Exam Prep Guide</a>
				</div>
			</div>
		</div>
			</div>
...
<a href="https://certification.adobe.com/courses/210">AD0-E906 Adobe Workfront for Experience Manager enhanced connector Expert
</a>
<br>
<br>
<b>Important:</b><br>
