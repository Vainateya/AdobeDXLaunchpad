# Adobe Experience Manager
                    ...
                    Sites Developer Professional (NEW)
...
After exam
Renew certification
This is the most updated exam for the Adobe Experience Manager Sites Developer Professional certification. If you have not started studying yet, you should use the study materials on this page and be sure to schedule the AD0-E128 exam.


If you have already started studying for the older exam, AD0-E123, we recommend that you continue studying and take the older exam as planned. The AD0-E123 exam will expire after February 10, 2025, so be sure to take it before that date.
EXAM ID:
AD0-E128
LEVEL:
...
Adobe Experience Manager Developers
...
3-6 months of experience working with the AEM Platform
...
Identify how to create and manage AEM custom logs
Identify how to implement a proxy of a core-component
Given a scenario, identify how to create component functionality including the HTL, models, and services
...
Given a scenario, outline the purpose of content fragments or experience fragments
Given a scenario, determine the correct steps to implement editable templates
Identify the correct Maven project structure
Given a scenario, identify how to configure projects from archetypes
Identify the purpose of AEM maintenance releases
Identify how to configure AEM across topologies
Given a scenario, identify the issues with the replication process
Identify how to create custom Oak indexes
Given a scenario, identify which log to analyze
Given a scenario, determine how to debug the client libraries
Given a scenario, identify which steps are involved in debugging AEM dispatcher configurations and caching
Given a scenario, determine the steps to debug issues in AEM environments
...
This course is an introduction to Adobe Experience Manager (AEM). Learners will be introduced to key concepts, solutions, product features, and use cases related to the AEM ecosystem.
...
<html dir="ltr" lang="en-US"><head>
    ...
    <base href="/certification/sites-developer-professional-v2">
    ...
    <title>
                Adobe Digital Experience Certification Program | Sites Developer Professional (NEW)
            </title>
    <!-- Stylesheets -->
    <!-- Core -->
...
<body class="stretched pace-running device-lg"><div class="pace pace-active"><div class="pace-progress" data-progress-text="21%" data-progress="21" style="transform: translate3d(21.838%, 0px, 0px);">
...
<ul class="no-padding d-flex justify-content-end sf-js-enabled" style="touch-action: pan-y;">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                                ...
                                <a href="/certifications">Certification Catalog</a>
                                                    ...
                                                    <li class="breadcrumb-item" aria-current="page">
                                <a href="/certification/sites-developer-professional-v2">Adobe Experience Manager Sites Developer Professional (NEW)</a>
                            </li>
                                            </ol>
                </nav>
            </div>
    ...
    <div class="certificate-info">
        <div class="title_section main-header" style="background-image: url(//images.ctfassets.net/pbnabi38gdk3/2UtXDKhSTPXpZcLGPUi0ms/e6d29a06365b2c07128944517c6e48f5/Cert_Exam_Header_KMK_TURQUOISE_Professional.png); background-size: contain;">
            <div class="container">
                ...
                <h1 class="text-white">Adobe Experience Manager
                    <br>
                    Sites Developer Professional (NEW)</h1>
	...
	<li class="nav-item" role="presentation"><button class="nav-link" id="certificate7" data-bs-toggle="tab" data-bs-target="#CertificateCont7" type="button" role="tab" aria-controls="CertificateCont7" aria-selected="false" data-tab="renew-certification" tabindex="-1">Renew certification</button></li>
        ...
        <div class="container">
			...
			<div class="d-flex">
				<img src="/content/rockwell/images/icons/Msg-icon.png" alt="Icon">
				<div class="flex-grow-1 ps-3">
					<p class="text-white m-0">This is the most updated exam for the Adobe Experience Manager Sites Developer Professional certification. If you have not started studying yet, you should use the study materials on this page and be sure to <a href="/courses/1232" style="color:#fff; text-decoration:underline !important">schedule the AD0-E128 exam.</a>
<br>
<br>
If you have already started studying for the older exam, <a href="/certification/sites-developer-professional" style="color:#fff; text-decoration:underline !important">AD0-E123</a>, we recommend that you continue studying and take the older exam as planned. The AD0-E123 exam will expire after <strong>February 10, 2025</strong>, so be sure to take it before that date.
</p>
				</div>
			</div>
		</div>
		...
		<div class="col-12">
			...
			<div class="row mx-0 px-2 px-md-4">
				...
				<div class="col-md-7">
					<p class="mb-0 text-dark">AD0-E128</p>
				</div>
			</div>
			<hr>
			<div class="row mx-0 px-2 px-md-4">
			...
			<div class="accordion-item">
				...
				<div id="exam-details-accordion-item-1" class="accordion-collapse collapse show">
					<div class="accordion-body">
						...
						<br>
						<ul>
  <li> Adobe Experience Manager Developers </li>
 <li>Front End Developers</li>
 <li>Software Engineers</li></ul>
					</div>
				</div>
			</div>
...
<ul>
  <li> 3-6 months of experience working with the AEM Platform</li>
<li>The ability to perform component development</li>
<li>A basic understanding of the MVC framework, life cycle frameworks and libraries in AEM</li>
<li>Understanding of the AEM development life cycle</li></ul>
					</div>
				</div>
			</div>
			...
			<div class="accordion-item">
				...
				<div id="exam-details-accordion-item-3" class="accordion-collapse collapse">
					<div class="accordion-body">
						<p> <strong> Section 1: Configurations (15%) </strong></p><strong> </strong>

<ul>
  <li> Recognize the purpose of AEM Dispatcher configurations and caching</li>
<li>Determine the correct steps to configure multi-site in AEM</li>
<li>Explain how to create and manage OSGi configurations</li>
<li>Determine the correct steps to manage custom Oak indices</li>
<li>Identify how to create and manage AEM custom logs</li></ul>

<br> <strong>Section 2: AEM development (37%)<p></p> </strong>

<ul>
  <li>Identify how to implement a proxy of a core-component</li>
  <li>Given a scenario, identify how to create component functionality including the HTL, models, and services </li>
  <li>Given a scenario, determine the correct steps to develop workflows</li>
  <li>Given a scenario, outline the purpose of content fragments or experience fragments</li>
<li>Given a scenario, outline the purpose of content fragments or experience fragments</li>
<li>Given a scenario, determine the correct steps to implement editable templates</li></ul>

<br> <strong>Section 3: Build and deployment (17%)<p></p> </strong>

<ul>
  <li>Identify the correct Maven project structure</li>
<li>Given a scenario, identify how to configure projects from archetypes</li></ul>

<br> <strong>Section 4: Environment maintenance (13%)<p></p> </strong>

<ul>
  <li>Identify the purpose of AEM maintenance releases</li>
<li>Identify how to configure AEM across topologies</li>
<li>Given a scenario, identify the issues with the replication process</li>
<li>Identify how to create custom Oak indexes</li></ul>

<br> <strong>Section 5: Analyzing and Debugging (18%)<p></p> </strong>

<ul>
  <li>Given a scenario, identify which log to analyze</li>
<li>Given a scenario, determine how to debug the client libraries</li>
<li>Given a scenario, identify which steps are involved in debugging AEM dispatcher configurations and caching</li>
<li>Given a scenario, determine the steps to debug issues in AEM environments</li></ul>
...
<div id="CertificateCont3" class="tab-pane fade" role="tabpanel" aria-labelledby="certificate3" tabindex="0">
	...
	<div class="cource-tab">
		<div class="row" style="padding-right:6%;padding-left:7%">
											<div class="col-md-6 col-lg-4 mb-4 mb-lg-0 d-flex" style="padding-right:5%;margin-left: 10%;margin-right: 4%">
									<div class="cource-grid bg-white flex-1">
						<div class="img-section">
							<img src="//images.ctfassets.net/pbnabi38gdk3/60lJDhSdH868FyqiZez6sR/b1332b13a59ec2277a692b30db6d9944/Course_Foundations_AEM_Experience_Manager.png" alt="">
						</div>
						<div class="cource-content">
							<span style="min-height: 25px">ADOBE EXPERIENCE MANAGER</span>
							<h5 style="min-height: 75px"> Adobe Experience Manager Foundations</h5>
							<p style="min-height: 100px">This course is an introduction to Adobe Experience Manager (AEM). Learners will be introduced to key concepts, solutions, product features, and use cases related to the AEM ecosystem. </p>

							<hr>
							<div class="d-flex flex-wrap justify-content-between align-items-center">
								<a href="https://certification.adobe.com/courses/1047" class="learn-more"><span>Learn More</span></a>
						...
						<div class="cource-content">
							<span style="min-height: 25px">ADOBE EXPERIENCE MANAGER</span>
							<h5 style="min-height: 75px">Adobe Experience Manager Sites for Developers - Professional </h5>
							<p style="min-height: 100px">Adobe Experience Manager Sites is the industry-leading content management system that empowers any marketer or developer to create high-performance pages across any digital property — from web to mobile to apps.</p>

							<hr>
							<div class="d-flex flex-wrap justify-content-between align-items-center">
								<a href="https://certification.adobe.com/courses/1064" class="learn-more"><span>Learn More</span></a>
								<p class="mb-0"><img src="/content/rockwell/images/certification/clock.png" width="18px" class="me-2" alt="clock"></p>
							</div>
						</div>
					</div>
...
Please remember that passing a practice test does not guarantee you will pass the certification exam.</p>
						<a href="https://certification.adobe.com/courses/1231" target="_blank" class="theme-btn btn-primary-blue">View Practice Test</a>
					</div>
				</div>
			</div>
								<div class="accordion-item">
			...
			<div id="study-exam-accordion-item-4" class="accordion-collapse collapse">
				<div class="accordion-body">
					...
					<a href="https://certification.adobe.com/courses/playScorm/1126" target="_blank" class="theme-btn btn-primary-blue">View Exam Prep Guide</a>
				</div>
			</div>
		</div>
			</div>
...
Click the link below to access the exam page, where you will schedule and pay for your exam. <br>
  ...
  <a href="https://certification.adobe.com/courses/1232">AD0-E128 Adobe Experience Manager Sites Developer Professional
</a>
<br>
<br>
<b>Important:</b><br>
