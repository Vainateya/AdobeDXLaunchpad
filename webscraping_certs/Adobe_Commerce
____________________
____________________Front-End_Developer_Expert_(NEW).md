# Adobe Commerce
                    ...
                    Front-End Developer Expert (NEW)
...
After exam
Renew certification
This is the most updated exam for the Adobe Commerce Front-end Developer Expert certification. If you have not started studying yet, you should use the study materials on this page and be sure to schedule the AD0-E727 exam.


If you have already started studying for the older exam, AD0-E720, we recommend that you continue studying and take the older exam as planned. The AD0-E720 exam will expire after March 30, 2025, so be sure to take it before that date.
EXAM ID:
AD0-E727
LEVEL:
...
AD0-E727 Adobe Commerce Front-end Developer Expert
Take your exam
...
<html dir="ltr" lang="en-US"><head>
    ...
    <base href="/certification/front-end-developer-expert-v2">
    ...
    <title>
                Adobe Digital Experience Certification Program | Front-End Developer Expert (NEW)
            </title>
    <!-- Stylesheets -->
    <!-- Core -->
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                                ...
                                <a href="/certifications">Certification Catalog</a>
                                                    ...
                                                    <li class="breadcrumb-item" aria-current="page">
                                <a href="/certification/front-end-developer-expert-v2">Adobe Commerce Front-End Developer Expert (NEW)</a>
                            </li>
                                            </ol>
                </nav>
            </div>
        ...
        <div class="title_section main-header" style="background-image: url(//images.ctfassets.net/pbnabi38gdk3/6QQTlXNRTcj9p5tzQ1U5hP/3a407eeffd9beeddb1f72f8b0f49e8d7/Cert_Exam_Header_KMK_RED_Expert.png); background-size: contain;">
            <div class="container">
                ...
                <h1 class="text-white">Adobe Commerce
                    <br>
                    Front-End Developer Expert (NEW)</h1>
        ...
        <div class="container">
			...
			<div class="d-flex">
				...
				<div class="flex-grow-1 ps-3">
					<p class="text-white m-0">This is the most updated exam for the Adobe Commerce Front-end Developer Expert certification. If you have not started studying yet, you should use the study materials on this page and be sure to <a href="/courses/1250" style="color:#fff; text-decoration:underline !important">schedule the AD0-E727 exam.</a>
<br>
<br>
If you have already started studying for the older exam, <a href="/certification/front-end-developer-expert" style="color:#fff; text-decoration:underline !important">AD0-E720</a>, we recommend that you continue studying and take the older exam as planned. The AD0-E720 exam will expire after <strong>March 30, 2025</strong>, so be sure to take it before that date.</p>
				</div>
			</div>
		</div>
		...
		<div class="col-12">
			...
			<div class="row mx-0 px-2 px-md-4">
				...
				<div class="col-md-7">
					<p class="mb-0 text-dark">AD0-E727</p>
				</div>
			</div>
			<hr>
			<div class="row mx-0 px-2 px-md-4">
			...
			<div class="row mx-0 px-2 px-md-4">
				...
				<div class="col-md-7">
					<p class="mb-0 text-dark">37/50</p>
				</div>
			</div>
			<hr>
			<div class="row mx-0 px-2 px-md-4">
...
<li> Front-end Developers</li>
			...
			<div class="accordion-item">
				...
				<div id="exam-details-accordion-item-2" class="accordion-collapse collapse">
					<div class="accordion-body">
						<p>You should have at least 1-3 years of hands-on experience with Adobe Commerce front-end development. You should have the ability to translate the needs expressed by task requirements into a technical solution.</p>
...
<li>Knowledge of extending and overwriting styles, layouts, and JS files
</li><li>Extending parent themes/Theme hierarchy</li>
...
<li>Understanding of Adobe Commerce Cloud infrastructure</li>
<li>Basic understanding of Cloud CLI command tool</li>
</ul>
					</div>
				</div>
			</div>
			...
			<div class="accordion-item">
				...
				<div id="exam-details-accordion-item-3" class="accordion-collapse collapse">
					<div class="accordion-body">
						<p> <strong> Section 1: Theme management (10%) </strong></p><strong> </strong>

<ul>
<li> Demonstrate the ability to create a new theme </li>
<li> Demonstrate ability to extend existing themes</li>
<li> Demonstrate ability to customize transactional emails</li>
<li> Demonstrate ability to apply translations,XML, and JS files</li>
</ul>

<br>

<p><strong>Section 2: Layout XML &amp; templates (22%)</strong></p><strong> </strong>
...
<li> Demonstrate ability to create and customize phtml templates </li>
<li> Apply template security (escaping output)</li>
</ul>

<br>

<p><strong>Section 3: Styles (12%)</strong></p><strong> </strong>

<ul>
<li>Explain the purpose of different LESS files (compiled and partial)</li>
<li>Demonstrate the ability to work with LESS files</li>
<li>Implement and customize LESS library components</li>
</ul>

<br>

<p><strong>Section 4: JavaScript (36%)</strong></p><strong> </strong>
...
<p><strong>Section 5: Customizing the Admin panel, Page Builder, and optimizations (20%)</strong></p><strong> </strong>

<ul>
<li>Demonstrate the ability to customize Page Builder content</li>
<li>Describe front-end optimization</li>
<li>Describe how to modify and extend the Commerce admin through the admin UI SDK</li>
<li>Define Grunt setup and usage</li>
<li>Utilize additional tools that Commerce Cloud provides</li>
<li>Describe steps to utilize Edge Delivery Service boiler plate</li>
</ul>
...
Please remember that passing a practice test does not guarantee you will pass the certification exam.</p>
						<a href="https://certification.adobe.com/courses/1251" target="_blank" class="theme-btn btn-primary-blue">View Practice Test</a>
					</div>
				</div>
			</div>
								<div class="accordion-item">
			...
			<div id="study-exam-accordion-item-4" class="accordion-collapse collapse">
				<div class="accordion-body">
					...
					<a href="https://certification.adobe.com/courses/1245" target="_blank" class="theme-btn btn-primary-blue">View Exam Prep Guide</a>
				</div>
			</div>
		</div>
			</div>
...
<a href="https://certification.adobe.com/courses/1250">AD0-E727 Adobe Commerce Front-end Developer Expert
</a>
<br>
<br>
<b>Important:</b><br>
