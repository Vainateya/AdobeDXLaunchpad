...
After exam
Renew certification
This is the most updated exam for the Adobe Commerce Developer Expert certification. If you have not started studying yet, you should use the study materials on this page and be sure to schedule the AD0-E725 exam.


If you have already started studying for the older exam, AD0-E716, we recommend that you continue studying and take the older exam as planned. The AD0-E716 exam will expire after February 17, 2025, so be sure to take it before that date.
EXAM ID:
AD0-E725
LEVEL:
...
You should have at least 2 years’ hands-on experience with Adobe Commerce, strong programming skills, and some experience with App Builder. They should have the ability to translate the needs expressed by task requirements into a technical solution.
This exam is based on (Adobe Commerce v2.4.7).
A candidate should have experience with and/or knowledge of:
Adobe Commerce
Adobe Commerce Coding Standards Technical Guidelines (https://developer.adobe.com/commerce/php/coding-standards/technical-guidelines/)
relational databases
the basic functions of both a web browser and server and how they communicate with one another
performance optimization and analysis as it relates to software
general understanding of the build and delivery process for Adobe Commerce
the built-in features/functionality of the application that may allow solutions without additional development
basic knowledge of Front-end and (i.e., HTML, CSS, LESS, PHP, , XML, MySQL)
working knowledge of Javascript, PHP, and Back-end Adobe Commerce technologies
...
AD0-E725 Adobe Commerce Developer Expert
Take your exam
...
<html dir="ltr" lang="en-US"><head>
    ...
    <base href="/certification/adobe-commerce-developer-expert-v2">
    ...
    <title>
                Adobe Digital Experience Certification Program | Developer Expert (NEW)
            </title>
    <!-- Stylesheets -->
    <!-- Core -->
...
<body class="stretched pace-running device-lg"><div class="pace pace-active"><div class="pace-progress" data-progress-text="30%" data-progress="30" style="transform: translate3d(30.9548%, 0px, 0px);">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                                ...
                                <a href="/certifications">Certification Catalog</a>
                                                    ...
                                                    <li class="breadcrumb-item" aria-current="page">
                                <a href="/certification/adobe-commerce-developer-expert-v2">Adobe Commerce Developer Expert (NEW)</a>
                            </li>
                                            </ol>
                </nav>
            </div>
        ...
        <div class="container">
			...
			<div class="d-flex">
				...
				<div class="flex-grow-1 ps-3">
					<p class="text-white m-0">This is the most updated exam for the Adobe Commerce Developer Expert certification. If you have not started studying yet, you should use the study materials on this page and be sure to <a href="/courses/1234" style="color:#fff; text-decoration:underline !important">schedule the AD0-E725 exam.</a>
<br>
<br>
If you have already started studying for the older exam, <a href="/certification/adobe-commerce-developer-expert" style="color:#fff; text-decoration:underline !important">AD0-E716</a>, we recommend that you continue studying and take the older exam as planned. The AD0-E716 exam will expire after <strong>February 17, 2025</strong>, so be sure to take it before that date.</p>
				</div>
			</div>
		</div>
		...
		<div class="col-12">
			...
			<div class="row mx-0 px-2 px-md-4">
				...
				<div class="col-md-7">
					<p class="mb-0 text-dark">AD0-E725</p>
				</div>
			</div>
			<hr>
			<div class="row mx-0 px-2 px-md-4">
...
<li> Technical Leaders</li>
			...
			<div class="accordion-item">
				...
				<div id="exam-details-accordion-item-2" class="accordion-collapse collapse">
					<div class="accordion-body">
						<p>You should have at least 2 years’ hands-on experience with Adobe Commerce, strong programming skills, and some experience with App Builder. They should have the ability to translate the needs expressed by task requirements into a technical solution.</p>

<p>This exam is based on (Adobe Commerce v2.4.7).</p>

<p>A candidate should have experience with and/or knowledge of:</p>

<ul>
<li>Adobe Commerce</li>
<li>Adobe Commerce Coding Standards Technical Guidelines (https://developer.adobe.com/commerce/php/coding-standards/technical-guidelines/)</li>
<li>relational databases</li>
<li>the basic functions of both a web browser and server and how they communicate with one another</li>
<li>performance optimization and analysis as it relates to software</li>
<li>general understanding of the build and delivery process for Adobe Commerce</li>
<li>the built-in features/functionality of the application that may allow solutions without additional development</li>
<li>basic knowledge of Front-end and (i.e., HTML, CSS, LESS, PHP, , XML, MySQL)</li>
<li>working knowledge of Javascript, PHP, and Back-end Adobe Commerce technologies</li>
</ul>
					</div>
				</div>
			</div>
			...
			<div class="accordion-item">
				...
				<div id="exam-details-accordion-item-3" class="accordion-collapse collapse">
					<div class="accordion-body">
						<p> <strong> Section 1: Architecture (38%)</strong></p><strong> </strong>
...
<p><strong>Section 2: External Integrations (14%)</strong></p><strong> </strong>
...
<p><strong>Section 3: Customizations (32%)</strong></p><strong> </strong>
...
<p><strong>Section 4: Cloud (16%)</strong></p><strong> </strong>
...
Please remember that passing a practice test does not guarantee you will pass the certification exam.</p>
						<a href="https://certification.adobe.com/courses/1236" target="_blank" class="theme-btn btn-primary-blue">View Practice Test</a>
					</div>
				</div>
			</div>
								<div class="accordion-item">
			...
			<div id="study-exam-accordion-item-4" class="accordion-collapse collapse">
				<div class="accordion-body">
					...
					<a href="https://certification.adobe.com/courses/1239" target="_blank" class="theme-btn btn-primary-blue">View Exam Prep Guide</a>
				</div>
			</div>
		</div>
			</div>
...
<a href="https://certification.adobe.com/courses/1234">AD0-E725 Adobe Commerce Developer Expert
</a>
<br>
<br>
<b>Important:</b><br>
