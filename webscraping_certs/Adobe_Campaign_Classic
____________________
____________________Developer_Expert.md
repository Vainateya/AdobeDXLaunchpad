...
<html dir="ltr" lang="en-US"><head>
    ...
    <base href="/certification/campaign-classic-developer-expert">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                                ...
                                <a href="/certifications">Certification Catalog</a>
                                                    ...
                                                    <li class="breadcrumb-item" aria-current="page">
                                <a href="/certification/campaign-classic-developer-expert">Adobe Campaign Classic Developer Expert</a>
                            </li>
                                            </ol>
                </nav>
            </div>
	...
	<li class="nav-item" role="presentation"><button class="nav-link" id="certificate7" data-bs-toggle="tab" data-bs-target="#CertificateCont7" type="button" role="tab" aria-controls="CertificateCont7" aria-selected="false" data-tab="renew-certification" tabindex="-1">Renew certification</button></li>
		...
		<div class="col-12">
			...
			<div class="row mx-0 px-2 px-md-4">
				...
				<div class="col-md-7">
					<p class="mb-0 text-dark">AD0-E330</p>
				</div>
			</div>
			<hr>
			<div class="row mx-0 px-2 px-md-4">
...
<li>Adobe Campaign Classic developer</li></ul>
					</div>
				</div>
			</div>
...
<ul>
<li> At least two years of Campaign software experience</li>
<li>At least three years of combined experience in JavaScript programming, SQL development including ETL, and web technologies (XML, HTML and web services)</li>
<li>Experience executing a marketing campaign using digital omnichannel</li>
<li>Experience with database architecture and knowledge of database marketing</li>
<li>Ability to map requirements to Campaign functionality</li>
<li>Ability to troubleshoot Campaign implementations</li>
<li>Basic understanding of server configurations related to Campaign</li></ul>
					</div>
				</div>
			</div>
			...
			<div class="accordion-item">
				...
				<div id="exam-details-accordion-item-3" class="accordion-collapse collapse">
					<div class="accordion-body">
						<p> <strong> Section 1: System configuration (16%)</strong></p><strong> </strong> 
...
<ul>
 ...
 <li>Identify Campaign Control Panel configuration features</li></ul>

<br> <strong>Section 2: Customization (22%)<p></p> </strong> 
...
<li>Describe commonly used OOTB functions</li></ul>

<br> <strong>Section 3: Access management (8%)<p></p> </strong> 
...
<li>Identify the limitations of data partitioning and when to use sysfilter</li> </ul>

<br> <strong>Section 4: Data integration (16%)<p></p> </strong> 
...
<li>Set up the CRUD process on a schema from outside of Adobe Campaign</li> </ul>

<br> <strong>Section 5: Instance maintenance (12%)<p></p> </strong> 
...
<li>Demonstrate basic system audit metrics/checks</li></ul>

<br> <strong>Section 6: Campaign configuration (25%)<p></p> </strong> 
...
<li>Given a use case, recommend complex targeting workflow design</li></ul>
					</div>
				</div>
			</div>
...
Please remember that passing a practice test does not guarantee you will pass the certification exam.</p>
						<a href="https://certification.adobe.com/courses/1007" target="_blank" class="theme-btn btn-primary-blue">View Practice Test</a>
					</div>
				</div>
			</div>
								<div class="accordion-item">
			...
			<div id="study-exam-accordion-item-4" class="accordion-collapse collapse">
				<div class="accordion-body">
					...
					<a href="https://certification.adobe.com/courses/1214" target="_blank" class="theme-btn btn-primary-blue">View Exam Prep Guide</a>
				</div>
			</div>
		</div>
			</div>
...
Click the link below to access the exam page, where you will schedule and pay for your exam. <br>
  ...
  <a href="https://certification.adobe.com/courses/180">AD0-E330 Adobe Campaign Classic Developer Expert
</a>
<p>
