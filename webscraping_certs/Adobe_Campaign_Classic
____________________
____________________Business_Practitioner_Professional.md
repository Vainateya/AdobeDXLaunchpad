...
AD0-E329
LEVEL:
Professional (0-12 months’ experience)
COST:
$125 (global) / $95 (India)
LANGUAGE(S):
English
...
Study resources
The application documentation provided here will be important to
						know for
						your exam.
...
Targeting activities in workflows
Flow control activities in workflows
Action activities in workflows
Workflow properties
Get started with workflows
Section 3: Data operations
Adobe Campaign workspace
Get started with workflows
Targeting activities in workflows
Get started with profiles
Get started with marketing campaigns
Work with Sources and Destinations
Section 4: Delivery configuration
Create and design email deliveries
Communication channels
About seed addresses
Get started with message tracking
Get started with personalization
Design and execute marketing campaigns
Section 5: Administration and reporting
About reports on deliveries
Get started with reporting
Get started with delivery monitoring
Get started with descriptive analysis
Get started with permissions
Schedule and pay for your exam
Schedule your proctored exam and pay the exam fee.
Make sure your legal name in your profile matches your government ID. If it does not match,  contact us prior to 24 hours before your exam appointment.
...
Exams must be rescheduled or canceled no less than 48 hours in
						advance of
						your exam time.
Candidates must modify their exam appointment themselves. Neither Adobe Support nor Meazure Learning can process rescheduling and cancellation requests.
To reschedule or cancel your appointment, click the link below to access the exam page.
AD0-E329 Adobe Campaign Classic Business Practitioner Professional
Take your exam
...
<html dir="ltr" lang="en-US"><head>
    ...
    <base href="/certification/campaign-classic-business-practitioner-professional">
    ...
    <title>
                Adobe Digital Experience Certification Program | Business Practitioner Professional
            </title>
    <!-- Stylesheets -->
    <!-- Core -->
...
<body class="stretched pace-running device-lg"><div class="pace pace-active"><div class="pace-progress" data-progress-text="52%" data-progress="52" style="transform: translate3d(52.2054%, 0px, 0px);">
...
<ul class="no-padding d-flex justify-content-end sf-js-enabled" style="touch-action: pan-y;">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                                ...
                                <a href="/certifications">Certification Catalog</a>
                                                    ...
                                                    <li class="breadcrumb-item" aria-current="page">
                                <a href="/certification/campaign-classic-business-practitioner-professional">Adobe Campaign Classic Business Practitioner Professional</a>
                            </li>
                                            </ol>
                </nav>
            </div>
    ...
    <div class="certificate-info">
        <div class="title_section main-header" style="background-image: url(//images.ctfassets.net/pbnabi38gdk3/2UtXDKhSTPXpZcLGPUi0ms/e6d29a06365b2c07128944517c6e48f5/Cert_Exam_Header_KMK_TURQUOISE_Professional.png); background-size: contain;">
            <div class="container">
                <span class="text-white">GET CERTIFIED</span>
                <h1 class="text-white">Adobe Campaign Classic
                    <br>
                    Business Practitioner Professional</h1>
	...
	<li class="nav-item" role="presentation"><button class="nav-link" id="certificate7" data-bs-toggle="tab" data-bs-target="#CertificateCont7" type="button" role="tab" aria-controls="CertificateCont7" aria-selected="false" data-tab="renew-certification" tabindex="-1">Renew certification</button></li>
		...
		<div class="col-12">
			...
			<div class="row mx-0 px-2 px-md-4">
				...
				<div class="col-md-7">
					<p class="mb-0 text-dark">AD0-E329</p>
				</div>
			</div>
			<hr>
			<div class="row mx-0 px-2 px-md-4">
				...
				<div class="col-md-7">
					<p class="mb-0 text-dark">Professional (0-12 months’ experience)</p>
				</div>
			</div>
			<hr>
			<div class="row mx-0 px-2 px-md-4">
				...
				<div class="col-md-7">
					<p class="mb-0 text-dark">$125 (global) / $95 (India)</p>
				</div>
			</div>
			<hr>
			<div class="row mx-0 px-2 px-md-4">
			...
			<div class="row mx-0 px-2 px-md-4">
				...
				<div class="col-md-7">
					<p class="mb-0 text-dark">32/50</p>
				</div>
			</div>
			<hr>
			<div class="row mx-0 px-2 px-md-4">
				...
				<div class="col-md-7">
					<p class="mb-0 text-dark">1 hour 40 mins</p>
				</div>
			</div>
			<hr>
		</div>
...
<li>Database marketer </li>
<li>Business practitioner </li>
<li>CRM project manager </li>
					</ul></div>
				</div>
			</div>
...
<ul>
  <li> A minimum of one year of foundational Campaign software experience </li>
 <li>An understanding of how to run a query</li>
 <li>An understanding of the toolkit that Adobe Campaign offers</li>
 <li>Knowledge of how to translate business objectives into workflow</li>
 <li>An understanding about targeting and segmenting an audience</li>
 <li>Experience with testing and sending a delivery</li>
 <li>Hands-on experience setting up cross- channel, personalized workflows and sending deliveries</li>
 <li>Experience analyzing and monitoring logs and errors</li>
 <li>An understanding of digital marketing concepts and tactics</li>
 <li>Basic understanding of automation, metrics, and campaign tactics (capabilities around data management, cloud services, approvals, and so on)</li>
 <li>An understanding of basic relational databases and of targeting queries in a campaign</li>
 <li>Experience with basic HTML and personalization</li>
 <li>Subscription service management (opt in/opt out)</li></ul>
					</div>
				</div>
			</div>
			...
			<div class="accordion-item">
				...
				<div id="exam-details-accordion-item-3" class="accordion-collapse collapse">
					<div class="accordion-body">
						<p> <strong> Section 1: Build a Campaign (29%)</strong></p><strong> </strong>

<ul>
  <li> Recognize the different Digital Marketing concepts and objectives </li>
<li> Identify and define key tool features and structure, in relation to the interface</li>
<li> Determine the appropriate delivery template with subdomain to use given Business Requirements</li>
<li> Identify the appropriate delivery preparation or personalization requirements given Business Requirements</li>
<li> Determine the correct target audience among profiles and analyze the results of the expected outcomes</li>
<li> Recommend and apply the correct campaign approval settings</li>
<li> Determine scheduling based on campaign requirements</li>
<li> Recognize where to locate delivery results or output</li>
<li> Differentiate between different error and warning types (delivery, campaign, and workflow level)</li> </ul>

 <br> <strong> Section 2: Workflow management and platform capabilities (16%)<p></p> </strong>

<ul><li>Given a scenario, determine which workflow activities should be selected</li>
<li>Differentiate between campaign and technical workflows</li>
<li>Given a scenario, determine which workflow solution is optimal for continuous, waits, recurring, aborts situations</li>
<li>Identify the new capabilities and features of Campaign V8 compared to previous versions</li> </ul>

<br> <strong> Section 3: Data operations (20%) <p></p> </strong>

<ul><li>Determine how to modify columns within a view to test data/output</li>
<li>Describe the purposes of the union, intersection, exclusion, and split workflow targeting activities</li>
<li>Determine the appropriate method to reconcile data, generate a complement, deduplicate, and import data</li>
<li>Given a scenario, identify which data enrichment rule should be used</li>
<li>Given a scenario, determine how to segment an audience and store as a list and cells</li>
<li>Given a scenario, determine the best method to export data to destinations by configuring them</li> </ul>

<br> <strong> Section 4: Delivery configuration (28%)<p></p> </strong>

<ul><li>Given a scenario, determine the correct delivery type</li>
<li>Given business requirements, determine how to create templates</li>
<li>Given business requirements, determine the correct delivery properties</li>
<li>Identify and apply OOTB personalization options available for a delivery (link to mirror page, greeting, un-sub link)</li>
<li>Given a scenario, determine the appropriate typology rule (control, filtering, pressure, capacity)</li>
<li>Identify the cause of a recipients’ exclusion of a delivery in the log and check delivery diagnostics</li>
<li>Indicate where/how to test delivery content and personalization</li>
<li>Differentiate among the various delivery states that occur during processing and apply actions</li> </ul>

<br> <strong> Section 5: Administration and reporting (7%) <p></p> </strong>

<ul> <li> Identify common OOTB reports and where to access them </li>
<li> Determine which OOTB report is needed based on reporting requirements</li>
<li> Identify the Descriptive Analysis functionality inside Adobe Campaign</li>
<li> Given a scenario, apply the right authorizations to limit/allow access to Campaign objects</li> </ul>
					</div>
				</div>
			</div>
...
Please remember that passing a practice test does not guarantee you will pass the certification exam.</p>
						<a href="https://certification.adobe.com/courses/1017" target="_blank" class="theme-btn btn-primary-blue">View Practice Test</a>
					</div>
				</div>
			</div>
						<div class="accordion-item">
			<h6 class="accordion-header">
				<button data-bs-toggle="collapse" aria-controls="study-exam-accordion-item-3" type="button" data-bs-target="#study-exam-accordion-item-3" aria-expanded="false" class="accordion-button d-block">
					<p class="mb-0"><strong>Study resources </strong></p>
					<p class="mb-0">The application documentation provided here will be important to
						know for
						your exam.</p>
				</button>

			</h6>
			<div id="study-exam-accordion-item-3" class="accordion-collapse collapse">
				<div class="accordion-body">
					<div class="d-flex flex-column">
						<p> <strong> Section 1: Build a Campaign </strong></p><strong> </strong> 

<ul>
  <li> <a href="https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/new/get-started#_blank"> Get Started with Adobe Campaign </a> </li>
<li> <a href="https://experienceleague.adobe.com/en/docs/campaign-classic/using/sending-messages/communication-channels#_blank"> Communication channels </a> </li>
<li> <a href="https://experienceleague.adobe.com/en/docs/campaign-classic/using/orchestrating-campaigns/orchestrate-campaigns/setting-up-marketing-campaigns#_blank"> Get started with marketing campaigns </a> </li>
<li> <a href="https://experienceleague.adobe.com/en/docs/campaign-classic/using/sending-messages/personalizing-deliveries/about-personalization#_blank"> Get started with personalization </a> </li>
<li> <a href="https://experienceleague.adobe.com/en/docs/campaign-classic/using/orchestrating-campaigns/about-marketing-campaigns/designing-marketing-campaigns#_blank"> Design and execute marketing campaigns </a> </li>
<li> <a href="https://experienceleague.adobe.com/en/docs/campaign-classic/using/sending-messages/using-delivery-templates/about-templates#_blank"> About templates </a> </li> </ul>
<p></p>
<p> <strong> Section 2: Workflow management and platform capabilities </strong></p><strong> </strong> 

<ul>
  <li> <a href="https://experienceleague.adobe.com/en/docs/campaign-classic/using/automating-with-workflows/targeting-activities/about-targeting-activities#_blank"> Targeting activities in workflows </a> </li>
<li><a href="https://experienceleague.adobe.com/en/docs/campaign-classic/using/automating-with-workflows/flow-control-activities/about-flow-control-activities#_blank"> Flow control activities in workflows </a> </li>
<li> <a href="https://experienceleague.adobe.com/en/docs/campaign-classic/using/automating-with-workflows/action-activities/about-action-activities#_blank"> Action activities in workflows </a> </li>
<li> <a href="https://experienceleague.adobe.com/en/docs/campaign-classic/using/automating-with-workflows/advanced-management/workflow-properties#_blank"> Workflow properties </a> </li>
<li> <a href="https://experienceleague.adobe.com/en/docs/campaign/campaign-v8/data/workflows#_blank"> Get started with workflows </a> </li></ul>
<p></p>
<p> <strong> Section 3: Data operations </strong></p><strong> </strong> 

<ul>
  <li><a href="https://experienceleague.adobe.com/en/docs/campaign-classic/using/getting-started/starting-with-adobe-campaign/campaign-workspace/adobe-campaign-workspace#_blank"> Adobe Campaign workspace </a> </li>
<li> <a href="https://experienceleague.adobe.com/en/docs/campaign-classic/using/automating-with-workflows/introduction/about-workflows#_blank"> Get started with workflows </a> </li>
<li> <a href="https://experienceleague.adobe.com/en/docs/campaign-classic/using/automating-with-workflows/targeting-activities/about-targeting-activities#_blank"> Targeting activities in workflows </a> </li>
<li> <a href="https://experienceleague.adobe.com/en/docs/campaign-classic/using/getting-started/profile-management/about-profiles#_blank"> Get started with profiles </a> </li>
<li> <a href="https://experienceleague.adobe.com/en/docs/campaign-classic/using/orchestrating-campaigns/orchestrate-campaigns/setting-up-marketing-campaigns#_blank"> Get started with marketing campaigns </a></li>
<li> <a href="https://experienceleague.adobe.com/en/docs/campaign-classic/using/integrating-with-adobe-experience-cloud/aep-sources-destinations/get-started-sources-destinations#_blank"> Work with Sources and Destinations </a> </li> </ul>
<p></p>
<p> <strong> Section 4: Delivery configuration </strong></p><strong> </strong> 

<ul>
  <li> <a href="https://experienceleague.adobe.com/en/docs/campaign-classic-learn/tutorials/sending-messages/email-channel/create-and-design-email-deliveries#_blank"> Create and design email deliveries </a> </li>
<li><a href="https://experienceleague.adobe.com/en/docs/campaign-classic/using/sending-messages/communication-channels#_blank"> Communication channels </a> </li>
<li> <a href="https://experienceleague.adobe.com/en/docs/campaign-classic/using/sending-messages/using-seed-addresses/about-seed-addresses#_blank"> About seed addresses </a> </li>
<li> <a href="https://experienceleague.adobe.com/en/docs/campaign-classic/using/sending-messages/tracking-messages/about-message-tracking#_blank"> Get started with message tracking </a></li>
<li><a href="https://experienceleague.adobe.com/en/docs/campaign-classic/using/sending-messages/personalizing-deliveries/about-personalization#_blank"> Get started with personalization </a> </li>
<li><a href="https://experienceleague.adobe.com/en/docs/campaign-classic/using/orchestrating-campaigns/about-marketing-campaigns/designing-marketing-campaigns#_blank"> Design and execute marketing campaigns </a> </li> </ul>
<p></p>
<p> <strong> Section 5: Administration and reporting </strong></p><strong> </strong> 

<ul>
  <li> <a href="https://experienceleague.adobe.com/en/docs/campaign-classic/using/reporting/reports-on-deliveries/reports-on-deliveries#_blank"> About reports on deliveries </a> </li>
<li><a href="https://experienceleague.adobe.com/en/docs/campaign-classic/using/reporting/reporting-in-adobe-campaign/about-adobe-campaign-reporting-tools#_blank"> Get started with reporting </a> </li>
<li><a href="https://experienceleague.adobe.com/en/docs/campaign-classic/using/sending-messages/monitoring-deliveries/about-delivery-monitoring#_blank"> Get started with delivery monitoring </a> </li>
<li> <a href="https://experienceleague.adobe.com/en/docs/campaign-classic/using/reporting/analyzing-populations/about-descriptive-analysis#_blank"> Get started with descriptive analysis </a> </li>
<li> <a href="https://experienceleague.adobe.com/en/docs/campaign-classic/using/getting-started/permissions/access-management#_blank"> Get started with permissions </a> </li> </ul>
					</div>
				</div>
			</div>
		</div>
...
<b>Resources</b>
<br>
Detailed information on <a href="https://certification.adobe.com/certifications/learn-more?%2Fcertifications%2Flearn-more=&amp;%3Btab=learnmore5&amp;tab=learnmore5">pricing, payment, and discounts</a>.
<br>
...
<a href="https://certification.adobe.com/courses/179">AD0-E329 Adobe Campaign Classic Business Practitioner Professional</a>
<br>
<br>
<b>Important:</b><br>
<ul>
<li>Make sure your legal name in your <a href="https://certification.adobe.com/user/profile">profile</a> matches your government ID. If it does not match, <a href="https://certification.adobe.com/support/contactus"> contact us</a> prior to 24 hours before your exam appointment.</li>
...
<a href="https://certification.adobe.com/certifications/learn-more?tab=learnmore6"> testing instructions</a> on how to prepare your computer and testing area.</li>
		...
		<div class="accordion-item">
			...
			<div id="schedule-accordion-item-2" class="accordion-collapse collapse">
				<div class="accordion-body">
					Cancellations and rescheduling must be initiated prior to 24 hours before the scheduled exam appointment. Appointments rescheduled under 24 hours beforehand are subject to a rescheduling fee. 
<p>
Candidates must modify their exam appointment themselves. Neither Adobe Support nor Meazure Learning can process rescheduling and cancellation requests.  
</p><p>
To reschedule or cancel your appointment, click the link below to access the exam page. 
	...
	<div class="accordion" id="schedule-take-exam-accordion-control">
		<div class="accordion-item">
			...
			<div id="schedule-take-exam-accordion-item-1" class="accordion-collapse collapse">
				<div class="accordion-body">
					Once you complete an exam, you receive a provisional pass or fail. The final score can take up to 72 hours to populate. At that time, you will find your result and score report in your <a href="https://certification.adobe.com/user/certifications">Completed exams</a> widget.
<p>
  </p><p>
If you fail to pass an Adobe certification exam on your first attempt, you must wait at least 24 hours before retaking the exam. Failure to pass an exam on the second or any subsequent attempt requires a waiting period of 14 calendar days before retaking the exam. Each attempt will incur a separate exam fee.
        ...
        $(function () {
            ...
            if (0 && 0 && 0)
            {
                ...
                $.ajax({
                    ...
                    url: cartUrl,
                    headers: {
                        "Authorization": "Bearer 173b04cc0d191406c7171e163a3fd572b2edf36365a04f2e4cf5001dee6d58e3d1ba386df356566d3c074df35620cb2c640c053a26bd2130963a7641"
                    }
