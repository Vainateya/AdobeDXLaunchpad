...
AD0-E502 Advertising Cloud DSP Business Practitioner Professional
...
Before you take your exam, read the  testing instructions on how to prepare your computer and testing area.
...
<html dir="ltr" lang="en-US"><head>
    ...
    <base href="/certification/advertising-dsp-business-practitioner-professional">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                                ...
                                <a href="/certifications">Certification Catalog</a>
                                                    ...
                                                    <li class="breadcrumb-item" aria-current="page">
                                <a href="/certification/advertising-dsp-business-practitioner-professional">Adobe Advertising DSP Business Practitioner Professional</a>
                            </li>
                                            </ol>
                </nav>
            </div>
    ...
    <div class="certificate-info">
        <div class="title_section main-header" style="background-image: url(//images.ctfassets.net/pbnabi38gdk3/2UtXDKhSTPXpZcLGPUi0ms/e6d29a06365b2c07128944517c6e48f5/Cert_Exam_Header_KMK_TURQUOISE_Professional.png); background-size: contain;">
            <div class="container">
                ...
                <h1 class="text-white">Adobe Advertising DSP
                    <br>
	...
	<li class="nav-item" role="presentation"><button class="nav-link" id="certificate7" data-bs-toggle="tab" data-bs-target="#CertificateCont7" type="button" role="tab" aria-controls="CertificateCont7" aria-selected="false" data-tab="renew-certification" tabindex="-1">Renew certification</button></li>
		...
		<div class="col-12">
			...
			<div class="row mx-0 px-2 px-md-4">
				...
				<div class="col-md-7">
					<p class="mb-0 text-dark">AD0-E502</p>
				</div>
			</div>
			<hr>
			<div class="row mx-0 px-2 px-md-4">
			...
			<div class="row mx-0 px-2 px-md-4">
				...
				<div class="col-md-7">
					<p class="mb-0 text-dark">44/69</p>
				</div>
			</div>
			<hr>
			<div class="row mx-0 px-2 px-md-4">
				...
				<div class="col-md-7">
					<p class="mb-0 text-dark">2 hours 18 mins</p>
				</div>
			</div>
			<hr>
		</div>
			...
			<div class="accordion-item">
				...
				<div id="exam-details-accordion-item-1" class="accordion-collapse collapse show">
					<div class="accordion-body">
						...
						<br>
						<ul>
  <li> Programmatic trader</li>
  <li> Paid media specialist</li>
  <li> Media director</li>
  <li> Campaign director</li>
<li> Media buyer</li></ul>
...
<ul>
  <li> 6+ months experience with Adobe Advertising</li>
<li>Experience in planning and or measuring key performance indicators in media buying software</li>
</ul>

<br>

  <p>You should also be familiar with the following tools and technologies:</p>

<ul>
  <li>Ad testing/debugging software (VAST INSPECTOR, Chrome developer tools)</li>
<li>Analytics tools (Adobe Analytics, Google Analytics)</li>
<li>Third-party tagging software (Sizmek, Google tag manager)</li>
<li>Third-party media quality tools (IAS, MOAT)</li>
<li>Major browsers</li>
<li>Ad exchanges, SSPs, and DMPs</li></ul>
					</div>
				</div>
			</div>
			...
			<div class="accordion-item">
				...
				<div id="exam-details-accordion-item-3" class="accordion-collapse collapse">
					<div class="accordion-body">
						<p> <strong> Section 1: Setting up campaigns (42%) </strong></p><strong> </strong>
...
<li> Apply procedural concepts required to set up Private and On demand inventories for a campaign</li> </ul>

<br> <strong> Section 2: Running and optimizing campaigns (22%)<p></p> </strong>
...
<li> Given a scenario, manage integrations with in-platform solutions</li> </ul>

<br> <strong>Section 3: Reporting and analyzing (26%)<p></p> </strong>
...
<li> Apply procedural concepts for attributing performance to a campaign</li> </ul>

<br> <strong>Section 4: Supplying recommendations for campaigns (10%)<p></p> </strong>

<ul> <li> Given a scenario, provide updates to clients based on a campaign</li> 
<li> Given a scenario, adjust campaign strategy based on campaign performance</li> </ul>
					</div>
				</div>
			</div>
			...
			<div id="study-exam-accordion-item-3" class="accordion-collapse collapse">
				<div class="accordion-body">
					<div class="d-flex flex-column">
						<p> <strong> Section 1: Setting up campaigns </strong></p><strong> </strong> 

<ul>
<li> <a href="https://experienceleague.adobe.com/en/docs/advertising/dsp/audiences/audience-about#_blank"> About Audience Management in Advertising DSP </a></li>
 <li><a href="https://experienceleague.adobe.com/en/docs/advertising/dsp/inventory/inventory-overview#_blank"> Overview of Inventory Features in Advertising DSP </a> </li>
 <li><a href="https://experienceleague.adobe.com/en/docs/advertising/dsp/campaign-management/campaigns/campaign-settings#_blank"> Campaign Settings </a> </li>
 <li><a href="https://experienceleague.adobe.com/en/docs/advertising/dsp/campaign-management/placements/placement-settings#_blank"> Placement Settings </a> </li> 
</ul>

<br>

<p> <strong> Section 2: Running and optimizing campaigns</strong></p><strong> </strong> 

<ul>
<li><a href="https://experienceleague.adobe.com/en/docs/advertising/dsp/optimization/optimization-how-dsp-optimizes-campaigns#_blank"> How Advertising DSP Optimizes Your Campaigns </a> </li>
<li> <a href="https://experienceleague.adobe.com/en/docs/advertising/dsp/optimization/custom-goals/custom-goal-about#_blank">About Custom Goals </a> </li>
<li> <a href="https://experienceleague.adobe.com/en/docs/advertising/dsp/optimization/campaign-best-practices-performance#_blank">Best Practices for Setting up Performance Campaigns </a> </li>
<li> <a href="https://experienceleague.adobe.com/en/docs/advertising/dsp/inventory/on-demand/on-demand-inventory-about#_blank"> About On Demand Premium Inventory </a> </li>
<li> <a href="https://experienceleague.adobe.com/en/docs/analytics-learn/tutorials/integrations/ad-cloud/reporting-with-advertising-cloud-marketing-channels#_blank"> Reporting with Advertising Marketing Channels </a> </li>
</ul>

<br>
<p> <strong> Section 3: Reporting and analyzing</strong></p><strong> </strong> 

<ul>
<li><a href="https://experienceleague.adobe.com/en/docs/experience-manager-65/content/implementing/deploying/configuring/web-console#_blank"> Web Console </a> </li> 
</ul>

<br>

<p> <strong> Section 4: Supplying recommendations for campaigns</strong></p><strong> </strong> 

<ul>
  <li><a href="https://experienceleague.adobe.com/en/docs/advertising/dsp/optimization/optimization-how-dsp-optimizes-campaigns#_blank"> How Advertising DSP Optimizes Your Campaigns </a> </li>
<li> <a href="https://experienceleague.adobe.com/en/docs/advertising/dsp/campaign-management/ads/ad-about#_blank"> About Ad Management in Advertising DSP </a> </li></ul>
					</div>
				</div>
			</div>
		</div>
...
<a href="https://certification.adobe.com/courses/190">AD0-E502 Advertising Cloud DSP Business Practitioner Professional
</a>
<br>
<br>
<b>Important:</b><br>
...
<li>Before you take your exam, read the <a href="https://certification.adobe.com/certifications/learn-more?tab=learnmore6"> testing instructions</a> on how to prepare your computer and testing area.</li>
</ul>
